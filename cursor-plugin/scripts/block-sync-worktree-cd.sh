#!/bin/bash
# PreToolUse hook (Claude Code): protect the a-sync JSONL worktree from destruction.
# Cursor does not invoke this automatically; see rules/thrum-safety.mdc for the same intent.
#
