...
description: "Connect Thrum daemons in different repos or on different machines via peers"
category: "onboarding"
order: 3
...
- Same-subnet connectivity **or** Tailscale installed and authenticated on both machines
...
2. [Cross-Machine Sync](../guides/cross-machine-sync.md) — end-to-end walkthrough
...
[Automated Plan Execution](orchestration.md) — hand a plan to a coordinator and let agents drive the work end to end.
