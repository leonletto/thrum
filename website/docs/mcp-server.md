...
title: "MCP Server"
description:
  "Model Context Protocol integration for Claude Code - native tools, WebSocket
  waiter, and message-listener pattern"
category: "mcp"
order: 1
tags: ["mcp", "claude-code", "tools", "websocket", "stdio", "integration"]
