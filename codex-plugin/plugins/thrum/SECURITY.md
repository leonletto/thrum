...
[thrum](https://github.com/leonletto/thrum) repository — open a private
security advisory rather than a public issue. Do not disclose details
publicly until a fix is available.

## Plugin scope

This plugin runs hook scripts under your local shell with your user
permissions. The scripts are auditable plain Bash under
`codex-plugin/scripts/`:
