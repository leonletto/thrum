...
export function HealthBar() {
  ...
  return (
    <footer
      className="fixed bottom-0 left-0 right-0 h-8 bg-[#0a0e1a] border-t border-cyan-500/10 flex items-center px-4 gap-4 text-[11px] font-mono z-20"
